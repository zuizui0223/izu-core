...
This hierarchy provides a more precise interpretation of apparent resilience in island plant reproduction. Similar endpoint states can arise because a lineage began in a favourable functional position, because local partners redirected service, or because reproductive assurance reduced the cost of lost service. Treating all three routes as a single buffer would obscure their different ecological meanings and different empirical measurement requirements.
