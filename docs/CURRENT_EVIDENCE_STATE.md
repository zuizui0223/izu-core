...
- External partial mechanism bridges: **6**.
...
- External screening has 6 independent partial mechanism bridges, including 1 near-complete within-archipelago system, but no complete bridge.
