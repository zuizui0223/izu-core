...
- External partial mechanism bridges: **5**.
...
- External screening has 5 independent partial mechanism bridges, including 1 near-complete within-archipelago system, but no complete bridge.
