...
- baseline response decomposition with prespecified seed-range context;
...
Include:
- the response-blind stepwise matching rule frozen before execution;
- all 11,520 step-pairs per matching seed exactly equal in realized richness;
- original realized-richness gap magnitude;
- all-positive mean geometry in 6/6 matching seeds;
- mixed individual realization range 51–65/96;
- 0.94–2.21 / 50.04–55.92 / 42.72–48.51% decomposition ranges;
- the prespecified gate failure and resulting claim reframe.

## Supporting tables

Tables S1-S8 retain the previous model/world/Izu inventory. Add:
...
Keep:
- Fig. S2 conditional-WHY diagnostics;
- Fig. S3 external-prediction readiness matrix;
- Fig. S4 joint regime map;
- Fig. S5 full local-filtering threshold curve;
- Fig. S6 full assurance sensitivity curve;
- **Fig. S7 realized-richness hard control:** six-seed decomposition range with mean all-positive / 51–65/96 individual mixed annotation.
...
- FDQ causes matching or matching causes pollen receipt;
