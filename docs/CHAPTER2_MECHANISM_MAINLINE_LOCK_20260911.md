...
### Realized-richness hard control
...
- a current Chapter 2 completion gate;
- a required bridge to Chapter 3;
- validation of the synthetic `k` crossover;
- proof of historical *Bombus* loss;
- a basis for calibrating the synthetic plant coordinate.
...
- a universal island phenotype;
- natural prevalence from synthetic branch frequencies;
