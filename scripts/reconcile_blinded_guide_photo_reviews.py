"""Reconcile completed geography and double-blind guide-photo review sheets.

Outputs are review drafts, never automatic model constraints. A user must inspect
source observations and approve any later update to guide_direction_constraints.
"""
...
def main() -> None:
    ...
    try:
        ...
        eligible, summary, drafts = reconcile_reviews(
            geographic,
            review_a,
            review_b,
            key,
        ...
        write_reconciliation(args.output_dir, eligible, summary, drafts)
