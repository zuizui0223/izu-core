...
def build_archive(output: Path, *, extra_deny_tokens: tuple[str, ...] = ()) -> Path:
    ...
    files = CORE_REVIEW_FILES + figure_files + ("data/results/chapter2_manuscript_figure_inputs_20260827.json",)
    records = validate_files(files, deny_tokens)
