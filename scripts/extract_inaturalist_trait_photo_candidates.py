"""Extract reviewable flower-photo candidate rows from an iNaturalist snapshot.
...
one observation. The script deliberately does not:

- assign an observation to an island;
- identify a floral trait from pixels;
- infer trait frequency or pollinator interaction;
- download, rehost, or redistribute any image.

It only makes source-linked candidates easier to inspect under a documented
review protocol.
"""
