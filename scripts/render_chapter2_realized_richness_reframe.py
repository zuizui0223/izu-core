...
def render_submission_manuscript() -> str:
    ...
    The realized-richness reframe is integrated directly into the active
    manuscript. Keeping this historical renderer as an identity layer preserves
    downstream imports without obsolete string-replacement anchors.
    """
    ...
    required = (
        ...
        "Same-block Izu E3/E4 measurements remain an optional future validation programme",
    )
    lower = text.lower()
