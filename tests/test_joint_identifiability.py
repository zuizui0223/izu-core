...
def test_current_repository_has_no_exact_joint_exposure_dependency_panel():
    ...
    assert state["decision"] == "not_identified_due_to_missing_same_population_overlap"
...
def test_audit_script_reproduces_committed_result(tmp_path):
