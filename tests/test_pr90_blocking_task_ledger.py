...
def test_core_blocking_tasks_are_separate_and_present():
    ...
    assert set(tasks) == {"hendriks_provenance", "third_floral_system", "empirical_reliability", "izu_direct_mechanism"}
...
def test_reliability_task_cannot_substitute_an_assumed_value():
    ...
    assert "machine_readable_empirical_reliability_unidentifiable_result_after_external_validation_search" in options
