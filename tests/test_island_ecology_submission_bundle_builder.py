...
def test_submission_bundle_contains_review_and_identity_separated_files(tmp_path: Path):
    ...
    with zipfile.ZipFile(output) as archive:
        ...
        assert "docs/ISLAND_ECOLOGY_JECOLOGY_SUBMISSION_DRAFT_V2_20260824.md" in names
