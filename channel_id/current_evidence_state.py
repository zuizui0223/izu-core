...
def summarize_current_evidence(root: str | Path) -> CurrentEvidenceState:
    ...
    return CurrentEvidenceState(
        ...
        next_actions=(
            ...
            "Replace synthetic variance, reliability, coverage, and loss assumptions only with pilot-derived quantities, then lock a biologically meaningful absolute precision target.",
